...
public class HomeController {
	...
	@GetMapping
	public String index(@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") Optional<LocalDate> targetDate,
								ModelMap model) {
		...
		StudentDetailsVO student = studentService
									.findDetailsByLoginId(SecurityContextHolder.getContext()
